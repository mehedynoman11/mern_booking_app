...
//       <div
//         className="p-7 border-b sm:border-r border-slate-600
//         md:min-h-screen"
//       >
...
//               id="searchTerm"
//               placeholder="search..."
//               className="border-2 border-slate-800 rounded-lg p-3 w-full"
...
//           rounded-lg uppercase">Search</button>
//         </form>
//       </div>
//       <div className="">
//         <h1 className="text-xl font-semibold border 
